...
class S3BucketConnector():
    ...
    def __init__(self, access_key:str, secret_key:str, endPoint_url:str, bucket:str) -> None:
        """
            ...
            var3 endPoint_url: endPoint_url for connecting to s3 bucket in the provider.
    ...
    def assignDate_s3BucketObj(self,startDate,date_format,bucketObj_list):
        """ covid19-harmonized-dataset in aws free dataset dont have date in files name then this 
            function create a artificial date for each it object to use them to loading data section
            based on date.
